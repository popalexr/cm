...
<div id="title">
		...
		<div id="container">
				...
				if(isset($_COOKIE['u'])) 
				{
					...
					echo '<form action="save_scoala.php" method="post">
					<table border="0">
					<tr><td>Denumire:</td><td><input type="text" name="s" value="'.$scoala.'"/></td></tr>
					<tr><td>Adresa:</td><td><input type="text" name="a" value="'.$adresa.'"/></td></tr>
					<tr><td>Ip:</td><td><input type="text" name="i" value="'.$ipscoala.'"/></td></tr>
					<tr><td>Numar sali:</td><td><input type="text" name="sali" value="'.$sali.'"/></td></tr>
					<tr><td>Numar de statii per sala:</td><td><input type="text" name="locuri" value="'.$locuri.'"/></td></tr>
					<tr><td>Adresa de E-Mail:</td><td><input type="text" name="email" value="'.$email.'"/></td></tr>
